...
function playerFeedback(){
    ...
    if(p1totalscore > parseInt(-36) && p1totalscore < parseInt(-10)){document.getElementById("p1feedback").innerHTML="Doin Real Good!"}
    if(p1totalscore > parseInt(-10) && p1totalscore < 0){document.getElementById("p1feedback").innerHTML="Nice!"}
